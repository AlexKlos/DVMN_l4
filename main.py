...
coordinates = (img_offset/2, 0, red_channel.width-img_offset/2, red_channel.height)
...
coordinates = (img_offset/2, 0, blue_channel.width-img_offset/2, blue_channel.height)
...
coordinates = (img_offset/2, 0, green_channel.width-img_offset/2, green_channel.height)
green_channel = green_channel.crop(coordinates)

result_image = Image.merge('RGB', (red_channel_blended, green_channel, blue_channel_blended))
